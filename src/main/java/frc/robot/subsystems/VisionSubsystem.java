...
public class VisionSubsystem extends SubsystemBase {
    ...
    private Consumer<Translation3d> pose_consumer;
    ...
    public void setConsumer(Consumer<Translation3d> pose) {
        this.pose_consumer = pose;
    }
    ...
    public void periodic() {
        ...
        if (pose_consumer != null) {
            var poes = getTranslation();

            if (poes.isPresent()) {
                pose_consumer.accept(poes.get());
            }
        }
    }
}
